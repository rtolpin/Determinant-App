...
function (_React$Component) {
  _inherits(MatrixInput, _React$Component);
  ...
  function MatrixInput(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MatrixInput).call(this, props));
    _this.state = {
      size: undefined,
      matrixVals: [],
  ...
  _createClass(MatrixInput, [{
    ...
    value: function addToMatrixVals(e) {
      if (!isNaN(e.target.value) || e.target.value === "") {
        ...
        var row = matVals[key].slice();

        for (var i = 0; i < inputVals.length; ++i) {
          var curr = inputVals[i];
    ...
    key: "renderMatrixRows",
    value: function renderMatrixRows(ele, key) {
      var _this2 = this;

      var cols = [];

      for (var i = 0; i < this.state.size; ++i) {
        cols.push(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
          key: i,
          type: "text",
          className: "input matrix-box"
        }));
      }
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        onChange: function onChange(e) {
          return _this2.addToMatrixVals(e);
        }
      }, cols);
    }
  }, {
    key: "submitMatrix",
    value: function submitMatrix(e) {
      var _this3 = this;
      ...
      var containsEmpty = this.state.matrixVals.map(function (arr) {
      ...
      fetch(url, {
        ...
        body: "size=" + this.state.size + "&matrix=" + JSON.stringify(this.state.matrixVals)
      }).then(function (res) {
        return res.json();
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("form", {
        className: "matrix_input_form",
        onSubmit: function onSubmit(e) {
          return _this4.submitMatrix(e);
        }
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("label", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "Enter Size of Matrix:"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
        type: "text",
        name: "size",
...
function Determinant(props) {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    className: "text"
  }, "Determinant:"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", {
    className: "determinant"
  }, props.determinant));
}

react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(MatrixInput, null), document.getElementById('root'));
